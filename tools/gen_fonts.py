...
Without --preview it emits the chosen fonts as the library's C arrays
(include/pedal_core/font_data.hpp + src/font_data.cpp). Those are the only font
tables that exist: a product's documentation screenshots are rendered by
compiling them for the host, so nothing outside the firmware needs a copy.
...
# ---------------------------------------------------------------------------
# Emit: chosen fonts -> include/pedal_core/font_data.hpp + src/font_data.cpp
# ---------------------------------------------------------------------------
